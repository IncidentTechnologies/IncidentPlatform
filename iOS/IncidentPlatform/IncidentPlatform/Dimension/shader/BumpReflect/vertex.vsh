//////////////////////////////////////////////
// PHONG REFLECTION WITH BUMP VERTEX SHADER //
//////////////////////////////////////////////
...
float4x4 g_ReflectionProjectionMatrix;
...
VS_OUTPUT vs_main( in VS_INPUT In )
{
    ...
    /*
    //Out.Reflection = In.Texture;        // Reflection projection coordinates
    Out.Reflection.x = dot(In.Position, g_ReflectionProjectionMatrix[0]);
    Out.Reflection.y = dot(In.Position, g_ReflectionProjectionMatrix[1]);
    Out.Reflection.z = dot(In.Position, g_ReflectionProjectionMatrix[2]);  //In.Texture;        // Reflection projection coordinates
    */    

    //Out.Reflection = mul(In.Position, g_ReflectionProjectionMatrix);
    Out.Reflection = mul(TransPos, g_ReflectionProjectionMatrix);
    
    /*Out.Reflection.x = 0.5f * (ClipPos.w + ClipPos.x);
    Out.Reflection.y = 0.5f * (ClipPos.w - ClipPos.y);
    Out.Reflection.z = ClipPos.w;*/
